                        ...
                        <form id="myForm" action="{{ url('edit-reserve/'. $key) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    @if ($errors->has('last_name'))
                                        <small class="text-danger">{{ $errors->first('last_name', $editdata['last_name']) }}</small>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="phone" value="{{ old('phone', $editdata['phone']) }}" class="form-control">
                                    @if ($errors->has('phone'))
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $editdata['email']) }}" class="form-control">
                                    @if ($errors->has('email'))
                            ...
                            <div class="row">
                                    ...
                                    <select name="region" id="region" class="form-control">
                                        <option value="" disabled selected>Select a Region</option>
                                            @foreach ($addressData as $region)
                                                <option value="{{ $region['id'] }}" {{ old('region', $editdata['region']) == $region['id'] ? 'selected' : '' }}>
                                                    {{ $region['name'] }}
                                                </option>
                                            @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <option value="">Select a Province</option>
                                        @if(old('province' , $editdata['province']))
                                            <option value="{{ old('province', $editdata['province']) }}" selected>{{ old('province', $editdata['province']) }}</option>
                                        @endif
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <option value="">Select a City</option>
                                        @if(old('city', $editdata['city']))
                                            <option value="{{ old('city', $editdata['city']) }}" selected>{{ old('city', $editdata['city']) }}</option>
                                        @endif
                                    </select>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <select name="barangay" id="barangay" class="form-control" disabled>
                                        ...
                                        @if(old('barangay', $editdata['barangay']))
                                            <option value="{{ old('barangay', $editdata['barangay']) }}" selected>{{ old('barangay', $editdata['barangay']) }}</option>
                                        @endif
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="street_houseno" value="{{ old('street_houseno', $editdata['street_houseno']) }}" class="form-control" style="text-transform: uppercase;">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <select name="package_name" id="package_name" class="form-control">
                                        <option value="" disabled {{ old('package_name', $editdata['package_name']) ? '' : 'selected' }}>Select a Package</option>
                                        @foreach ($packages as $package)
                                            <option value="{{ $package['package_name'] }}" data-persons="{{ $package['persons'] }}"
                                                    {{ old('package_name', $editdata['package_name']) == $package['package_name'] ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="event_title" value="{{ old('event_title', $editdata['event_title']) }}" class="form-control">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <select name="menu_name" class="form-select" id="menu_name" {{ old('package_name') ? '' : 'disabled' }}>
                                        ...
                                        @if(old('menu_name', $editdata['menu_name']))
                                            <option value="{{ old('menu_name', $editdata['menu_name']) }}" selected>{{ old('menu_name', $editdata['menu_name']) }}</option>
                                        @endif
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="number" name="guests_number" value="{{ old('guests_number', $editdata['guests_number']) }}" class="form-control" id="guests_number" min="1">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input 
                                        ...
                                        id="sponsors" 
                                        name="sponsors" 
                                        value="{{ old('sponsors', $editdata['sponsors'] ?? 'N/A') }}" 
                                        class="form-control" 
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" id="event_date" name="event_date" value="{{ old('event_date', $editdata['event_date']) }}" class="form-control" placeholder="Select date">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" id="event_time" name="event_time" value="{{ old('event_time', $editdata['event_time']) }}" class="form-control" placeholder="Select time">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="venue" value="{{ old('venue', $editdata['venue']) }}" class="form-control">
                                    @if ($errors->has('venue'))
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" name="theme" value="{{ old('theme', $editdata['theme']) }}" class="form-control">
                                    @if ($errors->has('theme'))
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    <textarea name="other_requests" class="form-control">{{ old('other_requests', $editdata['other_requests'] ?? 'N/A') }}</textarea>
                                </div>
                            </div>
