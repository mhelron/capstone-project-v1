<footer style="color: #000; padding: 15px;">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center text-md-start" style="display: flex; align-items: center;">
                ...
                <h5 style="margin: 0; font-weight: bold;">Kyla and Kyle</h5> <!-- Title beside the logo -->
            </div>
            ...
            <div class="col-md-4 text-center text-md-start" style="text-align: left;">
                ...
                <p style="margin-top: 5px; font-size: 14px; text-align: center; font-weight: bold;">
