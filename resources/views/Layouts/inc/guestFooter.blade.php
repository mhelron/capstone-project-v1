    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center mt-3">
                ...
                <p style="margin: 5px 0; font-weight: bold; color: white;">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal" style="color: white; text-decoration: none;">Terms & Conditions</a>
                </p>
            </div>
        ...
        <div class="modal fade" id="termsModal" tabindex="-1" aria-labelledby="termsModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <!-- Close button with inline style for orange color -->
                    <button type="button" class="btn" id="closeBtn" style="background-color: darkorange; color: white;" data-bs-dismiss="modal"><strong>Close</strong></button>
                </div>
                </div>
            </div>
        </div>
         ...
         <!-- JavaScript for enabling the checkbox after scrolling -->
        <script>
           // Initialize modal using Bootstrap
                const termsModal = new bootstrap.Modal(document.getElementById('termsModal'));

            // Show the modal when the page loads or on a specific event (like clicking a button)
            window.onload = function() {
                termsModal.show();  // Show the modal automatically
            };
        </script>
