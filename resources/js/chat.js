...
, function(t, e, n) {
    ...
    function o(t, e) {
        ...
        for (a = arguments.length; a-- > 2; )
            k.push(arguments[a]);
        for (e && null != e.children && (k.length || k.push(e.children),
        delete e.children); k.length; )
    ...
    function d(t, e, n, r, o) {
        ...
        "key" === e)
            ...
            if ("style" === e) {
                ...
                r ? n || t.addEventListener(e, m, a) : t.removeEventListener(e, m, a),
    ...
    function v(t, e, n, r, o, i) {
        L++ || (q = null != o && void 0 !== o.ownerSVGElement,
    ...
    function b(t, e, n, r, o) {
        ...
        return !I && f && 1 === f.length && "string" == typeof f[0] && null != c && void 0 !== c.splitText && null == c.nextSibling ? c.nodeValue != f[0] && (c.nodeValue = f[0]) : (f && f.length || null != c) && g(i, f, n, r, I || null != p.dangerouslySetInnerHTML),
        w(i, e.attributes, p),
        q = a,
        i
    }
    function g(t, e, n, r, o) {
        ...
        if (0 !== v)
            for (var w = 0; v > w; w++) {
                ...
                null != T ? (m++,
                h[T] = O) : (C || (void 0 !== O.splitText ? !o || O.nodeValue.trim() : o)) && (d[g++] = O)
            }
        if (0 !== x)
            for (var w = 0; x > w; w++) {
                u = e[w],
                ...
                p = b(p, u, n, r),
                s = l[w],
                p && p !== t && p !== s && (null == s ? t.appendChild(p) : p === s.nextSibling ? f(s) : t.insertBefore(p, s))
            }
        if (m)
            for (var w in h)
                void 0 !== h[w] && _(h[w], !1);
    ...
    function _(t, e) {
        var n = t._component;
        n ? S(n) : (null != t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null),
    ...
    function w(t, e, n) {
        ...
        for (r in e)
            "children" === r || "innerHTML" === r || r in n && e[r] === ("value" === r || "checked" === r ? t[r] : n[r]) || d(t, r, n[r], n[r] = e[r], q)
    }
    function O(t) {
    ...
    function C(t, e, n) {
        var r, o = F[t.name];
        if (t.prototype && t.prototype.render ? (r = new t(e,n),
        A.call(r, e, n)) : (r = new A(e,n),
        r.constructor = t,
        r.render = T),
        o)
    ...
    function M(t, e, n, r) {
        if (!t._disable) {
            var o, a, s, c = t.props, u = t.state, l = t.context, f = t.prevProps || c, d = t.prevState || u, h = t.prevContext || l, m = t.base, b = t.nextBase, g = m || b, x = t._component, w = !1;
            if (m && (t.props = f,
            t.state = d,
            t.context = h,
            ...
            !w) {
                ...
                if ("function" == typeof N) {
                    var A = p(o);
                    a = x,
                    a && a.constructor === N && A.key == a.__key ? j(a, A, 1, l, !1) : (O = a,
                    ...
                    (g || 1 === e) && (s && (s._component = null),
                    T = v(s, o, l, n || !m, g && g.parentNode, !0));
                if (g && T !== g && a !== x) {
                    var P = g.parentNode;
                    P && T !== P && (P.replaceChild(T, g),
                    O || (g._component = null,
                    _(g, !1)))
                }
                if (O && S(O),
                ...
                T && !r) {
                    for (var k = t, D = t; D = D._parentComponent; )
                        (k = D).base = T;
                    T._component = k,
                    T._componentConstructor = k.constructor
                }
            }
            if (!m || n ? R.unshift(t) : w || (t.componentDidUpdate && t.componentDidUpdate(f, d, h),
    ...
    function N(t, e, n, r) {
        for (var o = t && t._component, i = o, a = t, s = o && t._componentConstructor === e.nodeName, c = s, u = p(e); o && !c && (o = o._parentComponent); )
            c = o.constructor === e.nodeName;
        return o && c && (!r || o._component) ? (j(o, u, 3, n, r),
        t = o.base) : (i && !s && (S(i),
        t = a = null),
        o = C(e.nodeName, u, n),
    ...
    function S(t) {
        ...
        t.base = null;
        var n = t._component;
        n ? S(n) : e && (e.__preactattr_ && e.__preactattr_.ref && e.__preactattr_.ref(null),
        t.nextBase = e,
        f(e),
        O(t),
        x(e)),
...
, function(t, e, n) {
    ...
    var o = n(0)
      ...
      , s = {
        adapter: function() {
            var t;
            return "undefined" != typeof XMLHttpRequest ? t = n(4) : "undefined" != typeof process && (t = n(4)),
            t
        }(),
        transformRequest: [function(t, e) {
            ...
            "" + t) : o.isObject(t) ? (r(e, "application/json;charset=utf-8"),
            JSON.stringify(t)) : t
        }
        ],
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        return new Promise(function(e, p) {
            ...
            ,
            d.onerror = function() {
                p(c("Network Error", t, null, d)),
                d = null
            }
            ,
            d.ontimeout = function() {
                p(c("timeout of " + t.timeout + "ms exceeded", t, "ECONNABORTED", d)),
                d = null
            }
            ,
    ...
    t.exports = function(t, e, n) {
        ...
        if (n)
            ...
            o.forEach(e, function(t, e) {
                null !== t && void 0 !== t && (o.isArray(t) ? e += "[]" : t = [t],
...
, function(t) {
    ...
    function n(t) {
        for (var n, o, i = t + "", a = "", s = 0, c = r; i.charAt(0 | s) || (c = "=",
        s % 1); a += c.charAt(63 & n >> 8 - s % 1 * 8)) {
    ...
    e.a = function(t) {
        function e(n) {
            ...
            return r.handleKeyPress = function(t) {
                13 === t.keyCode && r.input.value.replace(/\s/g, "") && (r.say(r.input.value),
                r.input.value = "")
            }
            ,
            r.handleSendClick = function() {
                r.say(r.textarea.value),
                r.textarea.value = ""
            }
            ,
    ...
    e.a = function(t) {
        function e() {
            ...
            e.messageVisibilityChange = function(t, n) {
                ...
                r.id === t.id && r.visible !== n.visible && (r.visible = n.visible,
                r.timeout = 0,
                e.forceUpdate())
            }
            ,
    ...
    !function() {
        ...
        var c = function() {
            ...
            return function(r, u, p, l) {
                if (1 !== arguments.length || "string" !== s(r) || /\d/.test(r) || (u = r,
                r = void 0),
                r = r || new Date,
...
, function(t, e, n) {
    ...
    e.a = function(t) {
        ...
        e.prototype.performAction = function(t) {
            ...
            // Step 1: Send the selected button text as the visitor's message
            var userMessage = {
                text: t.text,  // The text from the selected button
                type: 'visitor',  // Mark it as a visitor's message
                from: 'visitor'  // Ensure it's sent by the visitor
            };
        
            // Call the message handler to display the visitor's message immediately
            e.props.messageHandler(userMessage);
        
            // Step 2: Make the API call (this remains unchanged)
            o.a.callAPI(t.value, true, null, function(t) {
                e.state.attachmentsVisible = false;
